...
def test_is_model_valid(model_name, dataset_name, feature_index, expected, results_dict_path):
    model_dict = load_json_as_dict(results_dict_path)

    assert is_model_valid(model_dict, model_name, dataset_name, feature_index) == expected
